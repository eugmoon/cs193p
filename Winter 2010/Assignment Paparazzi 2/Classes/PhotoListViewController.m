...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = [NSString stringWithFormat:@"%@", [photo name]];
	cell.imageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"%@", [photo path]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[fetchedResultsController performFetch:&error];
	Photo *photo = [fetchedResultsController objectAtIndexPath:indexPath];
	photoDetailViewController.photoName = [photo path];
